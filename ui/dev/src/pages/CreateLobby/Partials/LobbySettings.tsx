    ...
    <div className="flex flex-col gap-4 h-full w-full">
      ...
      >
        ...
        <button
          ...
          className="rounded flex items-center justify-center bg-[#FFF153]/25 border-2 border-[#FFF153]/50"
        >
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <button
              ...
              className="w-12 h-12 rounded flex items-center justify-center bg-[#FFF153]/25 border-2 border-[#FFF153]/50"
            >
